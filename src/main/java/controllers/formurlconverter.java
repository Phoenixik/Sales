...
@Component
public class formurlconverter extends
    ...
    @Override
    public MultiValueMap<String, String> read(java.lang.reflect.Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
